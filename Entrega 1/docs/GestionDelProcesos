...
|                                | Organizar los acertijos en un banco de preguntas con respuestas                                   |       |
| **Diseño de la interfaz**      | Definir estructura visual de la página (inicio, sección de acertijos, resultados, etc.)           |       |
|                                | Crear prototipos de la interfaz (bocetos)                                                         |       |
|                                | Seleccionar paleta de colores y estilo visual                                                     |       |
|                                | Asegurar que la interfaz sea intuitiva y atractiva                                                |       |
| **Desarrollo Técnico**         | Frontend: programar la interfaz                                                                   |       |
...
|                                | Registrar evidencias de cada etapa (capturas de pantalla, diagramas, pruebas)                     |       |
|                                | Manual de usuario (cómo acceder, cómo jugar)                                                      |       |
| **Entrega y presentación**     | Subir la página a un servidor local o en línea (ej. GitHub)                                       |       |
|                                | Preparar presentación para explicar el funcionamiento y el aporte académico                       |       |
|                                | Presentar el producto final al profesor y al grupo                                                |       |
